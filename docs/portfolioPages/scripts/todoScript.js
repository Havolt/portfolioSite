function creElTD(type, cls, apnd, inHL, src, id){
...
let listObj = {
    ...
    createList: function(){
        ...
        for(let i = listObj.itemData.length-1; i >= 0; i--){
            ...
            creElTD('div', 'listItem', document.getElementsByClassName('listContain')[0]);
            creElTD('div', 'listItemCheck', document.getElementsByClassName('listItem')[listRunner]);
            ...
            creElTD('div', 'listItemText', document.getElementsByClassName('listItem')[listRunner], listObj.itemData[i].text);
            creElTD('div', 'listItemCross', document.getElementsByClassName('listItem')[listRunner], '<i class="fa fa-times"></i>');
            ...
            if(!listObj.itemData[i].starred){
            creElTD('div', 'listItemFav', document.getElementsByClassName('listItem')[listRunner], '<i class="fa fa-star"></i>');
            }else{
                creElTD('div', ['listItemFav', 'listItemFavSelect'], document.getElementsByClassName('listItem')[listRunner], '<i class="fa fa-star"></i>');
    ...
    clearAll: function(button){
        button.addEventListener('click', function(){
            ...
            if(listObj.itemData.length > 0){
                creElTD('div', 'clearAllBG', document.getElementById('app'));
                creElTD('div', 'clearAllWindow', document.getElementsByClassName('clearAllBG')[0]);
                creElTD('div', 'clearAllTop', document.getElementsByClassName('clearAllWindow')[0], 'Clear All Tasks?');
                creElTD('div', ['clearAllButton', 'clearAllYesButton'], document.getElementsByClassName('clearAllWindow')[0], 'Yes');
                creElTD('div', ['clearAllButton', 'clearAllNoButton'], document.getElementsByClassName('clearAllWindow')[0], 'No');
...
(function initApp(){
    creElTD('div', 'app', document.getElementById('main'), '', '', 'app');
    creElTD('div', 'titleContain', document.getElementById('app'));
    creElTD('h1', 'toDoTitle', document.getElementsByClassName('titleContain')[0], 'To Do List');
    creElTD('div', 'newListContain', document.getElementById('app'));
    creElTD('input', 'newListInput', document.getElementsByClassName('newListContain')[0]);
    creElTD('button', 'newListButton', document.getElementsByClassName('newListContain')[0], 'Add Task');
    listObj.getTask(document.getElementsByClassName('newListButton')[0]);
    creElTD('div', 'listContain', document.getElementById('app'));
    creElTD('div', ['optionsAllContain', 'optionsContainHide'], document.getElementById('app'));
    creElTD('div', 'optionsMenu', document.getElementsByClassName('optionsAllContain')[0], '<i class="fa fa-bars"></i>');
    listObj.showOptionsBurger(document.getElementsByClassName('optionsMenu')[0]);
    creElTD('div', 'optionsContain' , document.getElementsByClassName('optionsAllContain')[0]);
    creElTD('div', 'optionsMinimize', document.getElementsByClassName('optionsContain')[0], '<i class="fa fa-window-minimize"></i>');
    listObj.hideOptionsBurger(document.getElementsByClassName('optionsMinimize')[0]);
    creElTD('div', ['optionsButton', 'optionsSelect'], document.getElementsByClassName('optionsContain')[0], 'Show All');
    creElTD('div', 'optionsButton', document.getElementsByClassName('optionsContain')[0], 'Incomplete');
    creElTD('div', 'optionsButton', document.getElementsByClassName('optionsContain')[0], 'Finished');
    listObj.addOptionButtonFunction(document.getElementsByClassName('optionsButton'));
    creElTD('div', 'clearButton', document.getElementsByClassName('optionsContain')[0], 'Clear All');
