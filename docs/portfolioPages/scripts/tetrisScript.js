...
(function initProjectData(){
    projectDataInfo('Tetris', initApp, 'This is my own version of the classic videogame Tetris. It has multiple difficulty levels, sound toggle, next shape display, a score and time system.');
})()
