...
(function initProjectData(){
    projectDataInfo('Snake', initApp, 'Classic game of Snake created using Canvas. The goal is to collect as many pieces of food as possible. Make sure to avoid the walls and don\'t touch your own tail. Control the game using the arrow keys.');
})()